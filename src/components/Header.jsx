    ...
    return (
        <motion.div className='flex flex-col items-center justify-center text-center my-20'
            ...
            >Unleash your creativity with AI.Turn your
                imagination into visual art in seconds- just type, and watch the magic hsppen.
            </motion.p>
            <motion.button onClick={onClickHandler}
                className='sm:text-lg bg-black text-white w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full cursor-pointer'
